...
如果你只需要一张静态图，先看 [GPT Image 2](/docs/runtime/gpt-image-2)。如果你要做演讲幻灯片，先看 [藏师傅的 PPT Skill](/docs/skills/magazine-web-ppt) 或 [Open Slide](/docs/tools/open-slide)。
...
| 需求 | 优先看 |
| --- | --- |
| 静态封面、海报、插图 | [GPT Image 2](/docs/runtime/gpt-image-2) |
