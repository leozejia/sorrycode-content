...
如果你只是第一次做 PPT，先看[藏师傅的 PPT Skill](/docs/skills/magazine-web-ppt)。如果你必须修改已有 `.pptx` 文件，先看[办公文档](/docs/skills/office-docs)。
...
| 需求 | 优先看 |
| --- | --- |
| 改已有 PowerPoint 文件 | [办公文档](/docs/skills/office-docs) |
