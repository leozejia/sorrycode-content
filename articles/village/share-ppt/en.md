...
1. Describe the topic, audience, and duration
2. Ask it to clarify and outline first
3. Confirm the outline before generating `index.html`
...
You have an `index.html` file that opens in the browser and flips horizontally.
