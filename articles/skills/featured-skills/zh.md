...
<h2 id="agent-install">让 Codex 帮你安装 Skills</h2>

如果你已经把 `Codex` 跑起来了，下一步不用自己研究 `npx`、`Git` 或 `Homebrew`。

把下面这段话复制给 Codex，让它自己读取当前文档、检查环境、判断要装哪些 skills：
...
- 想让 AI 编程流程更稳：[Skills / Waza](/docs/skills/waza)
