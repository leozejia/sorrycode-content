...
slug: grok-cli
order: 4
summary: 安装 Grok，并用自定义模型配置接到 SorryCode。
section: runtime
...
你可以在 SorryCode 控制台的 `接入工具` 里复制 Grok 一键安装命令；如果当前页面还没刷新到新入口，也可以按本文手动配置。
