...
- GPT Image 2 uses an OpenAI / Codex-group key, while Grok still uses a Grok-group key; do not assume keys are interchangeable because they all start with `sk-`
