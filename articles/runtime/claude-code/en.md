...
The one-click installer handles required dependencies automatically. On macOS, it checks `Command Line Tools / Homebrew / Git`, then installs `Node.js 22 LTS` and `Claude Code`.
