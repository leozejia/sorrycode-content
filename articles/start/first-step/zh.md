...
想知道适不适合你？[SorryCode 适合谁](/docs/start/who-is-sorrycode-for)。想理解成本和定价？[AI 成本怎么计算](/docs/start/ai-cost-basics)。
...
如果创建过程遇到问题，看 [创建 API Key](/docs/start/create-api-key) 的详细说明。
...
- [AI 成本怎么计算](/docs/start/ai-cost-basics) - 理解计费
